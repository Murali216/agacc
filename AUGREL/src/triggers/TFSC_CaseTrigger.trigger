trigger TFSC_CaseTrigger on Case (before insert, before update, after insert, after update) {
    ...
    new TFSC_TriggerDispatcher()
        ...
        -------------------end*/
        // Universal Console Enhancements
        .bind(TFSC_TriggerDispatcher.Evt.afterInsert, new TFSC_UCCaseTriggerHandler())
        .bind(TFSC_TriggerDispatcher.Evt.afterUpdate, new TFSC_UCCaseTriggerHandler())
